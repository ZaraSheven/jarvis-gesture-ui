      ...
      <div className="relative">
        ...
        >
          <div 
            ...
            style={{ backgroundColor: ringColor, boxShadow: `0 0 10px ${ringColor}` }}
          />
          <div 
          ...
          />
          <div 
            className="absolute left-0 top-1/2 w-2 h-2 rounded-full -translate-y-1/2 -translate-x-1/2"
            style={{ backgroundColor: ringColor, boxShadow: `0 0 10px ${ringColor}` }}
          />
          <div 
            className="absolute right-0 top-1/2 w-2 h-2 rounded-full -translate-y-1/2 translate-x-1/2"
            style={{ backgroundColor: ringColor, boxShadow: `0 0 10px ${ringColor}` }}
          />
        </div>
        ...
        <div 
          ...
          style={{
            ...
            boxShadow: `0 0 50px ${ringColor}30`
          }}
        >
          <div 
            ...
            style={{ 
              ...
              boxShadow: `0 0 20px ${ringColor}, 0 0 40px ${ringColor}60`,
        ...
        >
          ...
          <div 
            ...
            style={{ 
              ...
              textShadow: hasGesture ? `0 0 20px ${ringColor}80` : 'none'
            }}
          >
