    ...
    <div className="fixed top-0 left-0 right-0 z-20 p-6">
      <div className="flex justify-between items-start">
        <div className="space-y-3">
          <div className="bg-[#0a192f]/80 backdrop-blur-md border border-[#64ffda]/30 rounded-lg px-4 py-3 shadow-lg shadow-[#64ffda]/10">
            <div className="flex items-center gap-3">
              <Activity className="w-5 h-5 text-[#64ffda] animate-pulse" />
              <div>
                <div className="text-[#64ffda] text-xs font-mono uppercase tracking-wider">
                  System Status
                </div>
          ...
          <div className="bg-[#0a192f]/80 backdrop-blur-md border border-[#64ffda]/30 rounded-lg px-4 py-3 shadow-lg shadow-[#64ffda]/10">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <div className="w-20 h-2 bg-[#0a192f] rounded-full overflow-hidden border border-[#64ffda]/30">
                  <div 
                    className="h-full bg-[#64ffda] transition-all duration-500"
                    style={{ width: `${cpu}%` }}
                  />
                </div>
                <span className="text-[#64ffda] font-mono text-sm">{cpu}%</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#64ffda] font-mono text-sm">{memory}%</span>
              </div>
            </div>
          </div>
        </div>
